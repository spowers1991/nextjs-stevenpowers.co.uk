...
const MobileMenu = ({ mobileMenuToggleState, mobileMenuToggleCallback }) => {
  ...
  return (
      <div className={`${mobileMenuToggleState === 'open' ? 'translate-x-0' : 'translate-x-[100%] round'} duration-300 top-0 left-0 z-20 fixed w-full h-full bg-white lg:hidden mx-auto font-inter px-6 xl:px-6`}>
