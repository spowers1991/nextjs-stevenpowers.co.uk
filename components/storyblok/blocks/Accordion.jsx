      ...
      <div className={`accordion flex flex-col items-start`}>
        {blok.accordion.map((tab, index) => (
          <div className='w-full' key={index}>
            ...
            >
              <h4 className={`relative text-lg sm:text-2xl xl:text-3xl word-break max-w-[250px] lg:max-w-none ${openTabs[index] ? 'text-[#434bed]' : ''}`}>
                {tab.title}
            ...
            <div className={`panel ${openTabs[index] ? 'max-h-24' : 'max-h-0'} overflow-hidden duration-1000 border-b w-full`}>
              <div className="pb-5 max-w-[350px] md:max-w-[50%] ml-1 text-sm sm:text-base">
