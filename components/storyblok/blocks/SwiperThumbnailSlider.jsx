...
const [ref, inView] = useInView({
  ...
  return (
    <>
      <div ref={ref} className={`my-16 md:my-24  relative duration-1000 ease-out ${inView ? 'opacity-100' : 'opacity-20'}`}  {...storyblokEditable(blok)}>
      <div className='container mx-auto hidden md:flex my-6 px-6 md:px-12 xl:px-16 3xl:px-0 pt-8 lg:pt-0'>
