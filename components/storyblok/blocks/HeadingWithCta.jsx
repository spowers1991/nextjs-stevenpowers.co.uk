...
const HeadingWithCta = ({ blok, story }) => {
    ...
    return(
        <div ref={ref} className={`mx-auto container ${blok.border_bottom ? 'py-16 md:py-28 border-b' : 'my-16 md:my-28'} px-6 md:px-12 xl:px-16 3xl:px-0 duration-[1.25s] ${inView ? 'opacity-100' : 'opacity-20'}`} {...storyblokEditable(blok)}>             
