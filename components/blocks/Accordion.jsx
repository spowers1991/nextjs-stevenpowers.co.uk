...
const Accordion = ({ blok }) => {
  ...
  return (
    <div ref={ref} className={`container mx-auto px-6 xl:px-16 3xl:px-0 grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-20 py-16 md:py-24 border-b duration-500 ${inView ? 'opacity-100' : 'opacity-20'}`} {...storyblokEditable(blok)}>
      <div>
