...
const ContactForm = () => {
    ...
    return(
        <div className={`bg-white font-inter mx-auto container my-16 md:my-36 px-6 xl:px-0 !p-12  rounded duration-500`}>  
            ...
            <form className='w-full mx-auto sm:mr-16 sm:my-auto' name="contact" method="POST" onSubmit={handleFormSubmit} data-netlify={true} data-netlify-honeypot="bot-field">
