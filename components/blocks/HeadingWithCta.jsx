...
const HeadingWithCta = ({ blok }) => {
    ...
    return(
        <div ref={ref} className={`mx-auto container  ${blok.border_bottom ? 'py-16 md:py-24 border-b' : 'my-16 md:my-28 xl:my-36'} px-6 xl:px-0 mt-[50px] duration-500 ${inView ? 'opacity-100' : 'opacity-20'}`} {...storyblokEditable(blok)}>  
