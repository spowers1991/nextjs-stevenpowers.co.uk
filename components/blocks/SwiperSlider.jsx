...
const [ref, inView] = useInView({
  ...
  return (
    <>
      <div ref={ref} className={`my-16 md:my-24 !-mt-14 relative duration-1000 ease-out ${inView ? 'opacity-100' : 'opacity-20'}`}  {...storyblokEditable(blok)}>
        <div className='container mx-auto flex my-6 px-6 xl:px-16 3xl:px-0'>
            <div className='flex gap-x-3 text-[#434bed] ml-auto'>
              <div className={`swiper-prev-${blok._uid} cursor-pointer duration-150`}>
                  <svg className="w-5 h-5 sm:w-8 sm:h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 12c0 6.627 5.373 12 12 12s12-5.373 12-12-5.373-12-12-12-12 5.373-12 12zm7.58 0l5.988-5.995 1.414 1.416-4.574 4.579 4.574 4.59-1.414 1.416-5.988-6.006z"/></svg>
              </div>
              <div className={`swiper-next-${blok._uid} cursor-pointer  duration-150`} >
                  <svg className="w-5 h-5 sm:w-8 sm:h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.568 18.005l-1.414-1.415 4.574-4.59-4.574-4.579 1.414-1.416 5.988 5.995-5.988 6.005z"/></svg>
              </div>
            </div>
        </div>
        <Swiper
