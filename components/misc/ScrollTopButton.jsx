...
const ScrollTopButton = () => {
  ...
  return (
    <button
      className={`font-inter fixed bg-[#434bed] hover:bg-black py-3 px-5 text-white rounded-full uppercase text-[11px] sm:text-xs font-[500] tracking-[1px] text-center bottom-6 right-6 z-30 duration-300 ${
